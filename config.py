...
OUTPUT_REPO = "P2SAMAPA/p2-etf-rough-path-kernel-macro-results"
...
# All available macro variables (used as conditioning)
MACRO_VARS = [
...
SIG_DEPTH = 4               # truncated signature depth
KERNEL_BANDWIDTH = 1.0      # Gaussian kernel bandwidth
